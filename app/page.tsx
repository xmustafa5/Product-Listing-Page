...
function Page() {
  return (
    <div className="min-h-screen flex-1 flex flex-col items-center justify-center relative overflow-hidden container mx-auto px-4 py-8">
      ...
      <div className="relative z-10 px-4 sm:px-6 py-8 sm:py-12 backdrop-blur-sm bg-white/30 dark:bg-black/30 rounded-3xl shadow-2xl w-full max-w-3xl mx-4">
        <div className="text-center space-y-6 sm:space-y-8">
          <div className="space-y-2">
            <h2 className="text-xs sm:text-sm uppercase tracking-widest text-blue-600 dark:text-blue-400 font-semibold">
              Welcome to
            </h2>
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-600 dark:from-blue-400 dark:to-purple-400">
              Product Showcase
            </h1>
          </div>
          ...
          <div className="pt-2 sm:pt-4">
            <Link
              href="/product-task"
              className="group relative inline-flex items-center justify-center px-6 sm:px-8 py-3 sm:py-4 font-bold text-white transition-all duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
            >
              ...
              <span className="relative flex items-center space-x-2">
                ...
                <svg
                  className="w-4 h-4 sm:w-5 sm:h-5 ml-1 sm:ml-2 transform group-hover:translate-x-1 transition-transform duration-200"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
